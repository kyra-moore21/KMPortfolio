  ...
  return (
    <section className={styles.container} id="about">
        ...
        <ul className={styles.aboutItems}>
            <li className={styles.aboutItem}><img src={getImageUrl("serverIcon.png")} alt="server icon"/>
            <div  className={styles.aboutItemText}>
            <h3>Full Stack Developer</h3>
                <p>I am skilled in both front and backend development</p>
            </div>
            </li>
            <li className={styles.aboutItem}><img src={getImageUrl("uiIcon.png")} alt="UI Icon" />
            <div className={styles.aboutItemText}>
            <h3>UX/UI Designer</h3>
            <p>I have a passion for building user friendly and acessible websites</p>
            </div>
            </li>
            <li className={styles.aboutItem}><img src={getImageUrl("cursorIcon.png")} alt="Cursor Icon" />
            <div  className={styles.aboutItemText}>             
